...
class ScrollingSubtitlesGenerator:
    ...
    def video_with_scrolling_subtitles(self, input_audio, input_lyrics):
        input_visual = get_output_path(input_audio, 'final_visual_video.mp4')
        ...
        try:
            ...
            print("✅video with subtitles created as output_with_subtitles.mp4\n")
            return output
    ...
    def crop_video(self, input_audio):
        ...
        crop_height = (line_spacing + fontsize) * 5 + line_spacing
        crop_y = y_start_pos - (line_spacing + fontsize) * 3 - line_spacing
        crop_x = 0  
        if is_file_valid(output):
            print("✅cropped_subtitle.mp4 already exists and is valid. Skipping.....\n")
            return (crop_x, crop_y, crop_width, crop_height)
        print("🔄cropping subtitle video\n")
        ...
        try:
            ...
            print("✅Video cropped as cropped_subtitle.mp4\n")
            return (crop_x, crop_y, crop_width, crop_height)
        except subprocess.CalledProcessError as e:
    ...
    def overlay_cropped_video(self, input_audio, crop_params):
        ...
        if is_file_valid(output):
            ...
            return output
        print("🔄overlaying cropped video\n")
        x, y, _, _ = crop_params
        ...
        print(f"✅overlayed video created as final_output_with_subtitles.mp4\n")
        return output
    ...
    def add_title(self, input_audio):
        ...
        subprocess.run(ffmpeg_command, shell=True, check=True,  stdout=subprocess.DEVNULL, stderr=subprocess.STDOUT)
        print(f"✅final video created as {video_name}.mp4\n")
        return output_video
